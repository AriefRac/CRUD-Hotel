  ...
  <div :class="sidebarToggle ? 'justify-center' : 'justify-between'"
    ...
    <a href="<?= $main_url ?>">
      <span class="logo" :class="sidebarToggle ? 'hidden' : ''">
        <img class="dark:hidden" src="<?= $main_url ?>asset/logo/logo.png" alt="Logo" />
        <img class="hidden dark:block" src="<?= $main_url ?>asset/logo/logo.png" alt="Logo" />
      </span>

      <img class="logo-icon" :class="sidebarToggle ? 'lg:block' : 'hidden'"
        src="<?= $main_url ?>asset/logo/logo_icon.png" alt="Logo" />
    </a>
  </div>
  <!-- SIDEBAR HEADER -->
    ...
    <nav x-data="{selected: $persist('Dashboard')}">
      ...
      <div>
        ...
        <ul class="flex flex-col gap-4 mb-6">
          ...
          <!-- Menu Item Dashboard -->
          <li>
            <a href="<?= $main_url ?>" @click="selected = (selected === 'Dashboard' ? '':'Dashboard')"
          ...
          <!-- Menu Item Bookings -->
          <li>
            <a href="<?= $main_url ?>bookings/" @click="selected = (selected === 'Bookings' ? '':'Bookings')"
              class="menu-item group"
              :class=" (selected === 'Bookings') && (page === 'Bookings') ? 'menu-item-active' : 'menu-item-inactive'">
              <svg
                :class="(selected === 'Bookings') && (page === 'Bookings') ? 'menu-item-icon-active'  :'menu-item-icon-inactive'"
                width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path fill-rule="evenodd" clip-rule="evenodd"
          ...
          <li>
            <a href="<?= $main_url ?>guest/" @click="selected = (selected === 'Guest' ? '':'Guest')"
              ...
              <svg
                :class="(selected === 'Guest') && (page === 'Guest') ?  'menu-item-icon-active'  :'menu-item-icon-inactive'"
                width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path fill-rule="evenodd" clip-rule="evenodd"
          ...
          <li>
            <a href="<?= $main_url ?>room-types/" @click="selected = (selected === 'Room-Types' ? '':'Room-Types')"
              class="menu-item group"
          ...
          <li>
            <a href="<?= $main_url ?>user/" @click="selected = (selected === 'User' ? '':'User')"
              ...
              <svg :class="(selected === 'Guest') && (page === 'Guest') ?  'menu-item-icon-active'  :'menu-item-icon-inactive'" width="24" height="24" viewBox="0 0 24 24" fill="none"
                xmlns="http://www.w3.org/2000/svg">
                <path fill-rule="evenodd" clip-rule="evenodd"
